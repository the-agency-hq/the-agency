...
${tenant.issuer}/password/change/${changePasswordId}?tenantId=${user.tenantId}&client_id=7e1c9a54-0f8b-4a2e-9c6d-3b5f81d0a742&redirect_uri=${'http://localhost:8080/oidc/return'?url('UTF-8')}&response_type=code
