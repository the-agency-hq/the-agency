...
/**
 * The {@link RepositoryClient} for GitHub. Adds nothing to the contract: the type exists so the scope holds one
 ...
 */
public interface GitHubClient extends RepositoryClient {
}
